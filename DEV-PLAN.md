...
| P5 ✅ | 评审强化（REQ-057）：authorship 账本接线、静态发现入 review-pack、review 消费策略轴 | review 38/38 + cli-contracts 17/17 全绿；run-tests 355/355；摘 planned(P5)；偏差：dod 被测试夹具凭据字面量（tests/review.test.mjs:865/868，测试作者面拼接构造修复）卡住 fitness 步 |
